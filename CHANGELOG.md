...
- API configuration structs for named groups and arrays in the dataset.
- API function `ZarrStream_append_to_node` for appending data to a named group or array in the dataset.
