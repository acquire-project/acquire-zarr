...
BytePtr
zarr::Array::get_chunk_data_(uint32_t index)
{
    const auto& dims = config_->dimensions;
...
size_t
zarr::Array::compute_chunk_offsets_and_defrag_(uint32_t shard_index)
{
    const auto& dims = config_->dimensions;
