...
{
  public:
    explicit Downsampler(const ArrayConfig& config);
  ...
  private:
    ...
    std::unordered_map<int, ArrayConfig> writer_configurations_;
    ...
    void make_writer_configurations_(const ArrayConfig& config);
